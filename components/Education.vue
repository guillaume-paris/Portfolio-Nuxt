<template>
  <section id="education" class="min-h-screen flex justify-center items-center">
    <div>
      ...
      <div>
        ...
        <p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Nulla facilisi. Duis aliquet egestas purus in blandit. Curabitur vulputate, ligula lacinia scelerisque tempor, lacus lacus ornare ante, ac egestas est urna sit amet arcu. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Sed molestie augue sit amet leo consequat posuere. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Proin vel ante a orci tempus eleifend ut et magna. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus pharetra vel augue et venenatis.</p>
        <p>Sed sit amet orci eget libero ullamcorper tincidunt. Morbi libero lectus, laoreet in volutpat eu, varius vel massa. In hac habitasse platea dictumst. Fusce euismod consequat ante. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eget commodo orci. Integer varius neque vel libero adipiscing, et iaculis justo ornare. Etiam ante est, tempor ut posuere nec, venenatis vitae velit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
      </div>
    </div>
  </section>
</template>
